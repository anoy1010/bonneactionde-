                            ...
                            <div class="px-4 md:px-0 lg:w-6/12">
                                <div class="md:mx-6 md:p-12">
                                    ...
                                    <form action="../include/db.php" method="post">
                                        ...
                                        <div class="relative mb-4 border-2 rounded-full" data-te-input-wrapper-init>
                                            <input type="date" class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-0 data-[te-input-state-active]:placeholder:opacity-0 motion-reduce:transition-none dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0" id="exampleFormControlInput1" name="date_naissance" />
