...
<header class="bg-white absolute inset-x-0 top-0 z-50">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                ...
                <a href="../comps/Activity.php" class="rounded-md px-3.5 py-2.5 text-sm font-semibold leading-6 hover:bg-black hover:text-white text-gray-900">Nos activitées</a>
        
                <a href="../comps/Team.php" class="rounded-md px-3.5 py-2.5 text-sm font-semibold leading-6 hover:bg-black hover:text-white text-gray-900">Notre équipe</a>
        
                <a href="../comps/Contact.php" class="rounded-md px-3.5 py-2.5 text-sm font-semibold leading-6 hover:bg-black hover:text-white text-gray-900">Contact</a>
            </div>
