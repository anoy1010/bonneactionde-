              ...
              <div class="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <!-- Social network icons container -->
                  <div class="flex justify-center">
                    <a href="#!" class="mr-6 text-white w-10 h-10  hover:text-black  dark:text-neutral-200">
                      <svg
                    ...
                    <a href="#!" class="text-white hover:glass w-8 h-8 hover:text-black  dark:text-neutral-200">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-6 w-6  text-white shadow-sm  hover:text-black"
                        fill="currentColor"
