...
<header class="bg-white absolute inset-x-0 top-0 z-50">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <a href="../comps/" class="rounded-md px-3.5 py-2.5 text-sm font-semibold leading-6 hover:bg-black hover:text-white text-gray-900">Acceuil</a>
        
                <a href="#" class="rounded-md px-3.5 py-2.5 text-sm font-semibold leading-6 hover:bg-black hover:text-white text-gray-900">Nos missions</a>
        
                <a href="#" class="rounded-md px-3.5 py-2.5 text-sm font-semibold leading-6 hover:bg-black hover:text-white text-gray-900">Notre équipe</a>
        
                <a href="#" class="rounded-md px-3.5 py-2.5 text-sm font-semibold leading-6 hover:bg-black hover:text-white text-gray-900">Contact</a>
            </div>
