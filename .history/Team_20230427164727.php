...
<?php include("include/header.php") ?>
  ...
  <section class="mb-40 hero min-h-screen bg-cover bg-opacity-60  bg-top mx-auto max-w-auto py-52" style="
  background-image: url('images/Don de Sang 4.JPG')">
      
      <div class=" hero-overlay bg-opacity-60 text-center text-white py-24 px-6">
