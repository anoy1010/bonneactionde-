                ...
                <div class="w-full">
                    ...
                    <div class="block rounded-lg bg-white shadow-xl dark:bg-gray-800 ">
                        <div class="g-0 lg:flex lg:flex-wrap">
                            ...
                            <div class="flex items-center rounded-b-lg lg:w-6/12 lg:rounded-r-lg lg:rounded-bl-none bg-no-repeat bg-center bg-cover" style="background-image:url('images/277565917_385793799985425_876600948669581833_n.jpg');">
                                <div class="px-4 py-6 text-white md:mx-6 md:p-12">
                                    <div class=" mb-32 text-white text-center ">
                                        <div class="p-12">
                                            <h2 class="text-5xl bg-red-600 font-bold tracking-tight leading-tight my-12">
                                            ...
                                            <div class="flex flex-wrap justify-center md:space-x-2">
                                                <!-- Facebook -->
                                                <button type="button" target="_blank" onclick="window.location.href = 'https://www.facebook.com/Bonneactiondeplusci/';" data-mdb-ripple="true" data-mdb-ripple-color="light" class="inline-block py-2.5 px-6 mb-2 text-white font-medium text-xs leading-tight transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300 uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg flex items-center " style="background-color: #1877f2">
                                                ...
                                                <!-- Twitter -->
                                                <button type="button" target="_blank" data-mdb-ripple="true" data-mdb-ripple-color="light" class="inline-block py-2.5 px-6 mb-2 text-white font-medium text-xs leading-tight transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300 uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out flex items-center" style="background-color: #1da1f2">
                                                ...
                                                <!-- Google -->
                                                <button type="button" target="_blank" onclick="window.location.href = 'mailto:unebonneactiondeplus@gmail.com';" data-mdb-ripple="true" data-mdb-ripple-color="light" class="inline-block py-2.5 px-6 mb-2 text-white font-medium text-xs leading-tight transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300 uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out flex items-center" style="background-color: #ea4335">
                                                ...
                                                <!-- Instagram -->
                                                <button type="button"  target="_blank" onclick="window.location.href = 'https://instagram.com/konambin_gautier?igshid=YmMyMTA2M2Y=';" data-mdb-ripple-color="light" class="inline-block py-2.5 px-6 mb-2 text-white font-medium text-xs leading-tight transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300 uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out flex items-center" style="background-color: #c13584">
